...
class PendingViewer : CordaView("Pending Term Deposits") {
    ...
    override val widgets = listOf(CordaWidget("Pending Term Deposits", PendingWidget(), icon)).observable()
    // Left pane
    ...
    // Inject observables
    private val claimStates by observableList(TermDepositsModel::pendingStates)
